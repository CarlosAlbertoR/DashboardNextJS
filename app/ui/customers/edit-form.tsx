...
export default function EditCustomerForm({
  ...
  const [imgPath, setImgPath] = useState(customer.image_url);

  const handleImageChange = (image: string) => setImgPath(image);
      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          <legend className="mb-2 block text-sm font-medium">
            Choose the photo of the customer
          </legend>
          <div className="rounded-md border border-gray-200 bg-white px-[14px] py-3">
            <ImageUpload value={imgPath} onChange={handleImageChange} />
          </div>
